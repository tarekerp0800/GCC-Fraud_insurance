...
- Exceptional Cohen's Kappa (99.1%) indicates near-perfect agreement
- Strong F-Measure (89.3%) shows excellent precision-recall balance
...
**Strengths:**
- Highest raw accuracy (93.35%)
- Excellent recall (91.88%) - catches most positive cases

**Weaknesses:**
- Low precision (50.66%) - many false positives
- Poor Cohen's Kappa (28.67%) suggests overfitting to majority class
...
- Solid overall accuracy (86.97%)

**Weaknesses:**
- Moderate recall (59.97%) - misses some positive cases
